...
if ($TERM =~ '256' || &t_Co >= 256) || has("gui_running")
    ...
    hi Statement ctermbg=17 ctermfg=25 cterm=NONE guibg=#1c1c41 guifg=#77AAFF gui=NONE
    hi String ctermbg=17 ctermfg=25 cterm=NONE guibg=#1c1c41 guifg=#77AAFF gui=NONE
    ...
    hi StatusLineNC ctermbg=25 ctermfg=17 cterm=NONE guibg=#77AAFF guifg=#1c1c41 gui=NONE
    ...
    hi Pmenu ctermbg=17 ctermfg=25 cterm=NONE guibg=#1c1c41 guifg=#77AAFF gui=NONE
    hi PmenuSbar ctermbg=17 ctermfg=25 cterm=NONE guibg=#1c1c41 guifg=#77AAFF gui=NONE
    hi PmenuSel ctermbg=17 ctermfg=25 cterm=NONE guibg=#1c1c41 guifg=#77AAFF gui=NONE
    hi PmenuThumb ctermbg=17 ctermfg=25 cterm=NONE guibg=#1c1c41 guifg=#77AAFF gui=NONE
    ...
    hi DiffAdd ctermbg=17 ctermfg=15 cterm=NONE guibg=#1c1c41 guifg=#f8f8f8 gui=NONE
    hi DiffChange ctermbg=17 ctermfg=11 cterm=NONE guibg=#1c1c41 guifg=#ffff99 gui=NONE
    hi DiffDelete ctermbg=17 ctermfg=88 cterm=NONE guibg=#1c1c41 guifg=#701c1c gui=NONE
    hi DiffText ctermbg=17 ctermfg=215 cterm=NONE guibg=#1c1c41 guifg=#d99058 gui=NONE
    ...
    hi SpellBad ctermbg=17 ctermfg=88 cterm=NONE guibg=#1c1c41 guifg=#790914 gui=NONE
    hi SpellCap ctermbg=17 ctermfg=88 cterm=NONE guibg=#1c1c41 guifg=#790914 gui=NONE
    hi SpellLocal ctermbg=17 ctermfg=88 cterm=NONE guibg=#1c1c41 guifg=#790914 gui=NONE
    hi SpellRare ctermbg=17 ctermfg=88 cterm=NONE guibg=#1c1c41 guifg=#790914 gui=NONE
    hi ColorColumn ctermbg=8 ctermfg=15 cterm=NONE guibg=#585b70 guifg=#f8f8f8 gui=NONE
    hi SignColumn ctermbg=17 ctermfg=215 cterm=NONE guibg=#1c1c41 guifg=#d99058 gui=NONE
    hi ErrorMsg ctermbg=17 ctermfg=88 cterm=NONE guibg=#1c1c41 guifg=#790914 gui=NONE
    hi ModeMsg ctermbg=17 ctermfg=215 cterm=NONE guibg=#1c1c41 guifg=#d99058 gui=NONE
    hi MoreMsg ctermbg=17 ctermfg=11 cterm=NONE guibg=#1c1c41 guifg=#ffff99 gui=NONE
    hi Question ctermbg=17 ctermfg=88 cterm=NONE guibg=#1c1c41 guifg=#790914 gui=NONE
    hi Cursor ctermbg=17 ctermfg=25 cterm=NONE guibg=#1c1c41 guifg=#77AAFF gui=NONE
    hi CursorColumn ctermbg=8 ctermfg=15 cterm=NONE guibg=#585b70 guifg=#f8f8f8 gui=NONE
    hi QuickFixLine ctermbg=17 ctermfg=19 cterm=NONE guibg=#1c1c41 guifg=#0099e6 gui=NONE
    hi Conceal ctermbg=17 ctermfg=37 cterm=NONE guibg=#1c1c41 guifg=#00a693 gui=NONE
    hi ToolbarLine ctermbg=17 ctermfg=122 cterm=NONE guibg=#1c1c41 guifg=#5ee7d8 gui=NONE
    hi ToolbarButton ctermbg=17 ctermfg=80 cterm=NONE guibg=#1c1c41 guifg=#57c5c6 gui=NONE
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
    let g:terminal_ansi_colors = [ '#790914', '#701c1c', '#d99058', '#77AAFF', '#0099e6', '#f77fbe', '#fe28a2', '#008000', '#00a693', '#5ee7d8', '#57c5c6', '#1c1c41', '#6c7086', '#585b70', '#ffff99', '#f8f8f8' ]
endif
