...
if ($TERM =~ '256' || &t_Co >= 256) || has("gui_running")
    ...
    hi NonText ctermbg=17 ctermfg=8 cterm=NONE guibg=#1c1c41 guifg=#808080 gui=NONE
    hi Comment ctermbg=17 ctermfg=8 cterm=NONE guibg=#1c1c41 guifg=#808080 gui=NONE
    ...
    hi Ignore ctermbg=17 ctermfg=8 cterm=NONE guibg=#1c1c41 guifg=#808080 gui=NONE
    ...
    hi Underlined ctermbg=122 ctermfg=8 cterm=NONE guibg=#5ee7d8 guifg=#808080 gui=NONE
    hi StatusLine ctermbg=19 ctermfg=8 cterm=NONE guibg=#0099e6 guifg=#808080 gui=NONE
    hi StatusLineNC ctermbg=19 ctermfg=8 cterm=NONE guibg=#0099e6 guifg=#808080 gui=NONE
    ...
    hi Visual ctermbg=7 ctermfg=80 cterm=NONE guibg=#c0c0c0 guifg=#57c5c6 gui=NONE
    hi VisualNOS ctermbg=7 ctermfg=80 cterm=NONE guibg=#c0c0c0 guifg=#57c5c6 gui=NONE
    ...
    hi FoldColumn ctermbg=17 ctermfg=8 cterm=NONE guibg=#1c1c41 guifg=#808080 gui=NONE
    ...
    hi DiffChange ctermbg=88 ctermfg=8 cterm=NONE guibg=#701c1c guifg=#808080 gui=NONE
    hi DiffDelete ctermbg=88 ctermfg=8 cterm=NONE guibg=#790914 guifg=#808080 gui=NONE
    hi DiffText ctermbg=11 ctermfg=8 cterm=NONE guibg=#ffff00 guifg=#808080 gui=NONE
    hi IncSearch ctermbg=206 ctermfg=8 cterm=NONE guibg=#f77fbe guifg=#808080 gui=NONE
    ...
    hi ColorColumn ctermbg=7 ctermfg=88 cterm=NONE guibg=#c0c0c0 guifg=#790914 gui=NONE
...
elseif &t_Co == 8 || $TERM !~# '^linux' || &t_Co == 16
    ...
    hi ColorColumn ctermbg=gray ctermfg=darkred cterm=NONE
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
    let g:terminal_ansi_colors = [ '#1c1c41', '#790914', '#008000', '#d99058', '#0067a5', '#fe28a2', '#57c5c6', '#c0c0c0', '#808080', '#701c1c', '#008000', '#ffff00', '#0099e6', '#f77fbe', '#5ee7d8', '#f8f8f8' ]
endif
